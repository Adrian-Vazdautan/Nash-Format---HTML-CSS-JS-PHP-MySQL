...
<!--START : Appearance : Settings-->
	<div class="swppw-1">
		<!--START : Title-->
			<div class="swppw-1-1">
				<div class="p l">
					<div class="APPEARANCE_settings_appearance_js APPERANCE_DARK_text_css p l f16">
		...
		<!--END-->
		<!--START : Light-->
			<label for="swppw-1-2-ch-1-app" class="w100">
				<div class="APPEARANCE_settings_light_js APPERANCE_DARK_text_css swppw-1-2 f14">
		...
		<!--END-->
		<!--START : Dark-->
			<label for="swppw-1-2-ch-2-app" class="w100">
				<div class="APPEARANCE_settings_dark_js APPERANCE_DARK_text_css swppw-1-3 f14">
		...
		<!--END-->
		<!--START : Auto-->
			<label for="swppw-1-2-ch-3-app" class="w100">
				<div class="APPEARANCE_settings_auto_js APPERANCE_DARK_text_css swppw-1-3 f14">
