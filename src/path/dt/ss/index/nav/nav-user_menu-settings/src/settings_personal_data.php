...
<!--START : Personal data : Settings-->
	<div class="swppw0 p l">
		<!--START : Title-->
			<div class="APPEARANCE_settings_personal_data_js APPEARANCE_DARK_settings_personal_data_css swppw-0-1">
				<div class="p l">
					<div class="p l f16">
				...
				<!--START : Mobile, [Button]-->
					<div class="ab r0 t0 dg alc jcc desktop_none" style="width: 33px; height: 33px; margin-right: -8px;">
						<div class="p l w16">
							<div class="cadn41 p w16 h16 c" title="Закрой" onclick="uMWPU('close')"></div>
						</div>
					</div>
				<!--END-->
			</div>
		...
		<div class="swppw-0-1-1">
			<!--START : Upload avatar-->
				<div class="swppw011-1">
					<!--START : Title-->
						<span class="APPEARANCE_settings_upload_avatar_title_js APPERANCE_DARK_text_css swppw0111-s">
					...
					<!--START : Avatar-->
						<label for="avatarInput">
							<div class="swppw-0-1-1-1">
										        ...
										        #Check if query was successfull
										            if($query_image_name){
										                #Запрос выполнен успешно 
									    					$Show_Avatar = "<img loading='lazy' class='swppw0111-img' id='result_crop' draggable='false' src='src/du/avatar/". $query_image_name[0] ."'/>";
										            } else {
										                #В случае ошибки
										            }
											#END
								...
								?>
								<img loading='lazy' class='swppw0111-img' id='result_crop' draggable='false' src=''/>
			...
			<!--START : Form : City, Education, Work, Gen, Save, Cancel, Customize avatar-->
				...
				<div class="swppw011-2">
					<div class="csw02">
						<!--START : Input-->
							<span class="APPEARANCE_settings_nationality_js APPERANCE_DARK_text_css">
								Кто ты?
							</span>
							<input class="nationality_personal_data_js csw02input f14" type="text" placeholder="Национальность? Рептилойд?" value="<?= $query_get_personal_data[0];?>" onclick="clear_error_update_personal_data()">
							<div class="mt10 mb10 w100 f14 cr err_c_nationality none"></div>
						<!--END-->
						<!--START : Input-->
							<span class="APPEARANCE_settings_townCity_js APPERANCE_DARK_text_css mt10 p l">
								Откуда ты?
							</span>
							<input class="town_city_personal_data_js csw02input f14" type="text" placeholder="Не твой город" value="<?= $query_get_personal_data[1];?>">
						<!--END-->
						<!--START : Input-->
							<span class="APPEARANCE_settings_education_js APPERANCE_DARK_text_css mt10 p l">
								На кого учился?
							</span>
							<input class="education_personal_data_js csw02input f14" type="text" placeholder="Что ты типа знаешь?" value="<?= $query_get_personal_data[2];?>">
						<!--END-->
						<!--START : Gen : Radio-->
							<!--START : Title-->
								<span class="APPEARANCE_settings_gen_js APPERANCE_DARK_text_css mt10 p l w100">
									Пол если не секрет
								</span>
							<!--END-->
							<!--START : Female-->
								<div class="p l">
									...
									<div class="APPEARANCE_settings_female_js APPERANCE_DARK_text_css cbsgcss p l ml10 dg alc jcc f14">
										<label for="girl">
											Коза
										</label>
									</div>
							...
							<!--START : Male-->
								<div class="p l ml20">
									...
									<div class="APPEARANCE_settings_male_js APPERANCE_DARK_text_css cbsgcss p l ml10 dg alc jcc f14">
										<label for="men">
											Козел
										</label>
									</div>
						...
						<!--START : Crop : PopUp-->
							<div class="cadn1_crap_js pf w100 h100 dg alc jcc l0 t0 wrapp_crop_avatar_image none">
						        <div class="APPEARANCE_change_avatar_js APPEARANCE_DARK_change_avatar_js wrapp_crop">
						            <div class="APPEARANCE_settings_customize_picture_js APPERANCE_DARK_text_css wrapp_crop_1 f18">
						                Сделай по феншую
						            </div>
						            ...
						            <div class="wrapp_crop_3">
						                ...
						                <input type="submit" class="cOr mt10 w100 br4 bgw f14 c" value="Закрой" onclick="close_crop()">
						            </div>
						        </div>
						    </div>
						<!--END-->
