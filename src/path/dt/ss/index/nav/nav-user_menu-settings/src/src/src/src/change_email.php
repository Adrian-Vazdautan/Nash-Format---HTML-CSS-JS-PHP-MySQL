				        ...
				        elseif($query_get_email[0] == 0){
				        	#START : SEND
				        		...
				        		#START : Send code to email
						                ...
						                <body>
						                	<div class='melewr'>
												<div class='melewr_box'>
												    <h1>Подверди почту</h1>
												 	<p>Чтобы подтвердить свой адрес электронной почты, вам нужно выполнить один быстрый шаг.</p>
												 	<p>Пожалуйста, введите этот проверочный код при появлении соответствующего запроса.</p>
													<b>".$_SESSION["user"]["code"]."</b>
													<p>Не показывай никому этот код.</p>
												</div>
											</div>
						                </body>
						                </html>
						            ...
						            $message = $markup;
						            $headers = "From: no-reply@наш-формат.ру" . "\r\n" .
