...
<!--START : Notifications : Settings-->
	<div class="swppw-1">
		<!--START : Title-->
			<div class="swppw-1-1">
				<div class="p l">
					<div class="APPEARANCE_settings_notifications_js APPERANCE_DARK_text_css p l f16">
		...
		<!--END-->
		<!--START : Commentaries-->
			<label for="swppw-1-2-ch-1" class="w100">
				<div class="APPEARANCE_settings_comments_js APPERANCE_DARK_text_css swppw-1-2 f14">
		...
		<!--END-->
		<!--START : Likes-->
			<label for="swppw-1-2-ch-2" class="w100">
				<div class="APPEARANCE_settings_likes_js APPERANCE_DARK_text_css swppw-1-3 f14">
