...
<!--START : Add article-->
	<div class='a0tajs td'>
		...
		<div class="taw p">
			<div class="APPEARANCE_add_article_TITLE_js APPEARANCE_DARK_add_article_TITLE_js tat p l w100 f20 u">
				<?= $languagesLTAS[$selectedLanguage]['publish_an_article'];?>
			</div>
			<div class="APPEARANCE_add_article_js APPEARANCE_DARK_add_article_js taa p l w100 bgw br12">
				<!--START : sidebar left-->
					<div class="tai p l">
						<!--START : article title-->
						...
						<!--END-->
						<!--START : article thumbnail-->
							<?php require_once "sidebar-left/article-thumbnail.php"; ?>
						<!--END-->
