<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_FILES['thumbnailIMG'])) {
            ...
            $uploadDir = $_SERVER['DOCUMENT_ROOT'] . "/src/du/thumbnail/"; 
            ...
            if (move_uploaded_file($_FILES['thumbnailIMG']['tmp_name'], $uploadFile)) {
                ...
                /*Query->*/$query_delete_stb = mysqli_query($connect, "UPDATE `articles` SET `thumbnail_image` = '$avatar_username_timestamp_png' WHERE `articles`.`id` = '$responseJSONid';");
