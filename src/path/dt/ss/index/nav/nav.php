...
?>  
	<div class="naveljs mainNAVjs pf vw100 h57 l0 z3 df jcc" style="backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px);">
		<!--START : Mobile : ROW-BANNER-->
			<div class="mobile_AD_js MRB_nav_php_js w100 ab noneDesk">
				...
				<!--START : Button->(Add article) Button->(User menu with logo) Button->(Notify)-->
					<div class="tBjs">
						<!--START : Add new article : Button-->
							<div class="appearance_add_new_article_AANANA_js aa u p l c t f14 pal10 par10 mobile_none" id="addqwwd" onclick="addTheArticle()">
											        ...
											        #Check if query was successfull
											            if($query_image_name){
											                #Запрос выполнен успешно 
										    					$Show_Avatar = "<img loading='lazy' src='src/du/avatar/". $query_image_name[0] ."'/>";
											            } else {
											                #В случае ошибки
											            }
												#END
