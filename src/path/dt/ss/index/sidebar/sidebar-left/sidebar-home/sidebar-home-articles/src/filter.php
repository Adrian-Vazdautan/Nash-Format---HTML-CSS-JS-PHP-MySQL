    ...
    #START
        ...
        #New&Calendar
            elseif($filter__new_the_best == "new" && $filter__calendar_from != null && $filter__calendar_upto != null && $filter__menu != null && $filter__search == null){
                if($filter__menu == "all_topics"){
                    $FNTT_query = "
                        SELECT * FROM articles WHERE dateofpublication BETWEEN '$filter__calendar_from' AND '$filter__calendar_upto' ORDER BY id $limit;
                    ";
                } elseif($filter__menu != "all_topics"){
                    $FNTT_query = "
                        SELECT * FROM articles WHERE dateofpublication BETWEEN '$filter__calendar_from' AND '$filter__calendar_upto' AND category='$filter__menu' ORDER BY id $limit;
                    ";
                }
            }
        #The best&Calendar
