<?php
	...
	#START : Get avatar.png
		...
		#Check if image is NOT stored in BD
		    if($isp_Avatar == ""){
		    	$Show_Avatar = "<div class='image_avatar_css p l dg alc jcc br50 cw'>".substr($c_usernameOrNickname, 0, 1)."</div>";
		    } 
										...
										<div>
											<div class='buufjs aC c h40' onclick='unauthorized(0), hidePost(0)'>
									            <div class='ac1 p l h40 w16 dg alc'>
									            	<!--Icon-->
									        			<img loading='lazy' class='ac1ico' src='../src/du/icon/forbbiden.png'>
									        		<!--Icon-->
									            </div>
